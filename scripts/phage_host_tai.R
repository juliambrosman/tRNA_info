...
###############################################################################
## JMB added scripts to assist in running tAI.R for comparing codon adaptation in phage and host genomes:
###############################################################################
...
###So far, the below function has not been used for analysis... unclear if it will be useful or not:
